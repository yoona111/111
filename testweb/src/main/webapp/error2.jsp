...
<body>
  ...
  <script>
    ...
    <button onclick="redirectToRegistrationPage1()">change</button>
  <script>
    function redirectToRegistrationPage1() {
      // 跳转到注册页面
  ...
  <table>
    ...
    <input type="text" id="password" name="password">
      ...
      <br> 
    <span class="error-message">Please enter the correct account number or password</span> 
      </tr>
 </table>
 <div class="buttons">
